...
# CLASS NAME
package Kea::IO::Phylip::Sequential::WriterFactory;
use Kea::Object;
...
use Kea::IO::Phylip::Sequential::_FromAlignmentWriter;
...
sub createWriter {
	...
	if ($object->isa("Kea::Alignment::IAlignment")) {
		return Kea::IO::Phylip::Sequential::_FromAlignmentWriter->new($object);
		}
