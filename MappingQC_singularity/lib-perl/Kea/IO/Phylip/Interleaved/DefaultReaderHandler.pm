...
# CLASS NAME
package Kea::IO::Phylip::Interleaved::DefaultReaderHandler;
use Kea::Object;
use Kea::IO::Phylip::Interleaved::IReaderHandler;
our @ISA = qw(Kea::Object Kea::IO::Phylip::Interleaved::IReaderHandler);
