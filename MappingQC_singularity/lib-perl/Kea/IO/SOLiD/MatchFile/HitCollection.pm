...
# CLASS NAME
package Kea::IO::SOLiD::MatchFile::HitCollection;
use Kea::Object;
use Kea::ICollection;
...
sub add {
	...
	my $self = shift;
	my $object = $self->check(shift, "Kea::IO::SOLiD::MatchFile::Hit");
...
sub toString {
	...
	my @hitStrings;
	foreach my $hit (@{$self->{_array}}) {
		push(@hitStrings, $hit->toString);
		}
	
	return join(",", @hitStrings);
	} # End of method.
