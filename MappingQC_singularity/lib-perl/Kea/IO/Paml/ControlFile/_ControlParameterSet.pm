...
# CLASS NAME
package Kea::IO::Paml::ControlFile::_ControlParameterSet;
use Kea::Object;
use Kea::IO::Paml::ControlFile::IControlParameterSet;
our @ISA = qw(Kea::Object Kea::IO::Paml::ControlFile::IControlParameterSet);
...
sub new {
	...
	my $self = {
		_seqfile		=> Kea::Object->check($args{-seqfile}), # Obligatory regardless of control file.
		_treefile		=> $args{-treefile},
		_outfile		=> Kea::Object->check($args{-outfile}), # Obligatory regardless of control file.
		_noisy			=> $args{-noisy},
		_verbose		=> $args{-verbose},
		_runmode		=> $args{-runmode},
		_seqtype		=> $args{-seqtype},
		_CodonFreq 		=> $args{-CodonFreq},
		_aaDist 		=> $args{-aaDist},
		_model			=> $args{-model},
		_NSsites		=> $args{-NSsites},
		_icode			=> $args{-icode}, 
		_Mgene			=> $args{-Mgene},  
		_fix_kappa		=> $args{-fix_kappa},
		_kappa			=> $args{-kappa},
		_fix_omega 		=> $args{-fix_omega}, 
		_omega			=> $args{-omega},
		_ncatG			=> $args{-ncatG},
		_clock			=> $args{-clock},
		_getSE			=> $args{-getSE},
		_RateAncestor	=> $args{-RateAncestor},
		_Small_Diff		=> $args{-Small_Diff},
		_cleandata		=> $args{-cleandata},
		_fix_blength	=> $args{-fix_blength},
		_weighting		=> $args{-weighting},
		_commonf3x4		=> $args{-commonf3x4}
		};
...
sub getSeqfile {
	return shift->{_seqfile};
	} # End of method.

#///////////////////////////////////////////////////////////////////////////////

sub getTreefile {
	return shift->{_treefile};
	} # End of method.

#///////////////////////////////////////////////////////////////////////////////

sub getOutfile {
	return shift->{_outfile};
	} # End of method.
...
sub getAminoAcidDistance {
	return shift->{_aaDist};
	} # End of method.
