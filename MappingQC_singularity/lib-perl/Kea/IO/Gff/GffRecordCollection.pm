...
# CLASS NAME
package Kea::IO::Gff::GffRecordCollection;
use Kea::Object;
use Kea::ICollection;
...
sub add {
	...
	my $self = shift;
	my $object = $self->check(shift, "Kea::IO::Gff::IGffRecord");
...
sub toString {
	...
	my $self = shift;
	my @gffRecords = $self->getAll;
	
	my $text = "";
	
	foreach my $gffRecord (@gffRecords) {
		$text .= $gffRecord->toString . "\n";
		}
