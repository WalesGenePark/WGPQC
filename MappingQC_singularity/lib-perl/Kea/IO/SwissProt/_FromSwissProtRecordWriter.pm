...
# CLASS NAME
package Kea::IO::SwissProt::_FromSwissProtRecordWriter;
use Kea::Object;
use Kea::IO::IWriter;
...
sub new {
	...
	my $swissProtRecord =
		Kea::Object->check(shift, "Kea::IO::SwissProt::ISwissProtRecord");
	
	my $self = {
		_swissProtRecord => $swissProtRecord
		};
...
sub write {
	...
	my $swissProtRecord			 	= $self->{_swissProtRecord};
