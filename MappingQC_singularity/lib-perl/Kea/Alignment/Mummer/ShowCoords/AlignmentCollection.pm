...
# CLASS NAME
package Kea::Alignment::Mummer::ShowCoords::AlignmentCollection;
use Kea::Object;
use Kea::ICollection;
...
sub add {
	...
	my $self = shift;
	my $object = $self->check(shift, "Kea::Alignment::Mummer::ShowCoords::IAlignment");
