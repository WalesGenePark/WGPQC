...
# CLASS NAME
package Kea::Assembly::Newbler::AllDiffs::AlignmentLineCollection;
use Kea::Object;
use Kea::ICollection;
...
sub add {
	...
	my $self = shift;
	my $object =
		$self->check(shift, "Kea::Assembly::Newbler::AllDiffs::IAlignmentLine");
	
	push(@{$self->{_array}}, $object);
