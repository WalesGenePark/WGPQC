...
# CLASS NAME
package Kea::OrthologFinder::Orthomcl;

## Purpose		: Wrapper class for orthoMCL.
...
# MUST BE HARD CODED IN ORDER TO CORRECTLY WRITE orthomcl_module.pm ON THE FLY.
# todo NEED TO CHANGE THIS!
our $ORTHOMCL_PATH = "/Users/Kev/Bioinformatics_software/ORTHOMCL_V1.4_mcl-02-063/ORTHOMCLV1.4/";
our $WORKING_DIR = "orthomcl_out";
our $_TEMPLATE;
...
sub new {
	...
	warn "\n\t\t<<DEPRECATED: Note uses Orthomcl.pm which is deprecated in favour of OrthomclFactory etc.>>\n\n";
...
sub run {
	...
	my $mode = $args{-mode} or confess "\nERROR: No mode value provided";
	my $dataDir = $args{-data} or confess "\nERROR: No data directory provided";
	my $outfile = $args{-outfile} or confess "\nERROR: No outfile provided";

	my $TEMPLATE = $_TEMPLATE;
	
	# Create orthomcl_module.pm.
	open(OUT, ">$ORTHOMCL_PATH/orthomcl_module.pm") or confess "\nERROR: Could not create orthomcl_module.pm";
	$TEMPLATE =~ s/__ORTHOMCL_DATA_DIR__/$dataDir/;
	$TEMPLATE =~ s/__PATH_TO_ORTHOMCL__/$ORTHOMCL_PATH/;
	...
	opendir (DIR, "$dataDir") or confess "\nERROR: Could not open directory '$dataDir'";
	my $file;
	my @files;
	...
	# Run perl script.
	my $command = "$ORTHOMCL_PATH/orthomcl.pl --mode $mode --fa_files \"$fileString\"";
	...
	# Make copy to outfile.
	print ">>> $outfile created.\n";
	copy("$WORKING_DIR/all_orthomcl.out", $outfile) or confess "\nERROR: Could not make a copy of all_orthomcl.out";
...
# softwares
our $BLASTALL                            = "/Users/Kev/Bioinformatics_software/blast-2.2.17/bin/blastall";
...
our $FORMATDB                            = "/Users/Kev/Bioinformatics_software/blast-2.2.17/bin/formatdb";
our $MCL                                 = "/usr/local/bin/mcl";# "/Users/Kev/Bioinformatics_software/ORTHOMCL_V1.4_mcl-02-063/mcl-06-058/src/shmcl/mcl";   #"/Users/Kev/Bioinformatics_software/ORTHOMCL_V1.4_mcl-02-063/mcl-02-063/shmcl/mcl";
