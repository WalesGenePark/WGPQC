...
# CLASS NAME
package Kea::Statistics::ToolkitLite;
use Kea::Object;
...
sub getArithmeticMean {
	...
	return $self->getSum($data) / scalar(@$data);
...
sub getMode {
    ...
    return _odd_median(\@result);       # odd_median() is defined earlier.
	} 
