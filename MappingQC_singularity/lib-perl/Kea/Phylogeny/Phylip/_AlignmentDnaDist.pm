...
# CLASS NAME
package Kea::Phylogeny::Phylip::_AlignmentDnaDist;
...
use constant TMP_INFILE		=> "TMP_dnadist_infile.phy";
use constant TMP_OUTFILE	=> "TMP_dnadist_outfile.mat";
...
use Kea::ThirdParty::Phylip::_DnaDistWrapper; 
...
sub run {
	...
	# create tmp infile (phylip interleaved) for dnadist.
	...
	# Run dnadist
	my $dnadist = Kea::ThirdParty::Phylip::_DnaDistWrapper->new;
	$dnadist->run(
		-infile 	=> TMP_INFILE,
		-outfile 	=> TMP_OUTFILE,
		-D 			=> $D
